...
//Array<TIPO>
let pictureTitles: Array<string>; //let pictureTitles: string[]
...
//Tuple
//example [1, "user"]
let userIdentification: [number, string];
...
//array of tuples
let array: [number, string][] = []; //have to initialize with an empty array
