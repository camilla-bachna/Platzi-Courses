...
let hex: number = 0xf00d; //after 0x we can use 0 to 9 and a b c d e f

//valores binarios
let binary: number = 0b1010; //0b indicates that a binary value follows, only 0 and 1

//valores octales
let octal: number = 0o744; //0o indicates octal value and digits between 0 and 7

//Boolean
//Explicito
let isPro: boolean; //to indicate if a user that publishes photos is pro or not (has a license)
isPro = true;
