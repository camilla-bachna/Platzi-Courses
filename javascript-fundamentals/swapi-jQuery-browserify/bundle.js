...
function filmSingularOrPlural(films) {
  return films.length === 1 ? "He actuado en la película" : "He actuado en las películas";
}
...
function getACharacter(id) {
  return new Promise(function (resolve, reject) {
    var url = "".concat(apiUrl).concat(people.replace(":id", id));

    _jquery["default"].get(url, optionCharacter, function (data) {
      resolve(data);
    }).fail(function () {
      return reject(id);
    });
...
function getAFilm(filmUrl) {
  return new Promise(function (resolve, reject) {
    _jquery["default"].get(filmUrl, optionFilm, function (data) {
      resolve(data);
    }).fail(function () {
...
var _getFilmInfo = _interopRequireDefault(require("./getFilmInfo"));

var _filmSingularOrPlural = _interopRequireDefault(require("./filmSingularOrPlural"));
...
function getCharacterInfo(characters) {
  characters.map(function (_ref) {
    var name = _ref.name,
        films = _ref.films;
    console.group(name);
    console.log("Hola soy ".concat(name));
    console.log("".concat((0, _filmSingularOrPlural["default"])(films), " ").concat(films));
    (0, _getFilmInfo["default"])(name, films);
    console.groupEnd();
  });
}
...
var _getFilmTitle = _interopRequireDefault(require("./getFilmTitle"));
...
function getFilmInfo(name, films) {
  ...
  var promisesFilms = films.map(function (filmUrl) {
    return (0, _getAFilm["default"])(filmUrl);
  });

  try {
    var filmsOfCharacters = Promise.all(promisesFilms).then(function (filmsOfCharacters) {
      (0, _getFilmTitle["default"])(filmsOfCharacters, name);
    });
  } catch (_unused) {
...
function getFilmTitle(filmsOfCharacters, name) {
  console.group(name);
  filmsOfCharacters.map(function (_ref) {
...
},{"./getACharacter":2,"./getCharacterInfo":4,"regenerator-runtime/runtime":9}],8:[function(require,module,exports){
/*!
