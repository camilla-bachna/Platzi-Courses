...
})()(
  {
    ...
    4: [
      function (require, module, exports) {
        ...
        var _filmSingularOrPlural = _interopRequireDefault(
          require("./filmSingularOrPlural")
        );
        ...
        function getCharacterInfo(characters) {
          characters.map(function (_ref) {
            ...
            console.log(
              ""
                .concat((0, _filmSingularOrPlural["default"])(films), " ")
                .concat(films)
            );
      ...
      { "./filmSingularOrPlural": 1, "./getFilmInfo": 5 },
    ],
    5: [
      function (require, module, exports) {
        "use strict";
        ...
        function getFilmInfo(name, films) {
          ...
          try {
            var filmsOfCharacters = Promise.all(promisesFilms).then(function (
              filmsOfCharacters
            ) {
...
using the Star Wars API https://swapi.dev/. */
        ...
        var _getCharacterInfo = _interopRequireDefault(
          require("./getCharacterInfo")
        );
 ...
 */
        ...
        function onError(id) {
          console.log(
            "Sucedi\xE1 un error al obtener el personaje ".concat(id)
          );
        }
      },
      {
