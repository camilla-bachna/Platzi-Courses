 ...
 */
function getFilmInfo(_x, _x2) {
  return _getFilmInfo.apply(this, arguments);
}

function _getFilmInfo() {
  _getFilmInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, films) {
    var promisesFilms, filmsOfCharacters;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            console.log("Enter async function getFilmInfo");
            promisesFilms = films.map(function (filmUrl) {
              return (0, _getAFilm["default"])(filmUrl);
            });
            _context.prev = 2;
            _context.next = 5;
            return Promise.all(promisesFilms);

          case 5:
            filmsOfCharacters = _context.sent;
